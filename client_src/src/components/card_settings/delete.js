...
const __DeleteCard = function(props) {
...
const defaultRESTError = 'Unable to delete card. Please try again.';
const deleteCard = function(dispatch, deleteURL, submitting = true) {
